    ...
    return (
        <div className = "Plan">
            ...
            <form id = "p1" onSubmit ={handleSubmit}>
                <button type ="button" className = "Arcade" onClick = {() => {handleButton("Arcade")}} style = {{borderColor: plan === "Arcade"? "hsl(267, 100%, 62%)": !selected && "red"}}>
                    ...
                    <div className = "desc">
                        <p>Arcade</p>
                        <p className = "arcCost">{!MoYe? "$9/mo":"$90/yr " }<span>{MoYe && " +2 months free"}</span></p>
                    </div>
                </button>
                <button type ="button" className = "Advanced" onClick = {() => {handleButton("Advanced")}} style = {{borderColor: plan === "Advanced"? "hsl(267, 100%, 62%)": !selected && "red"}}>
                    ...
                    <div className = "desc">
                      <p>Advanced</p>
                        <p className = "arcCost">{!MoYe? "$12/mo":"$120/yr"}<span>{MoYe && " +2 months free"}</span></p>
                    </div>
                </button>
                <button type ="button" className = "Pro" onClick = {() => {handleButton("Pro")}} style = {{borderColor: plan === "Pro"? "hsl(267, 100%, 62%)": !selected && "red"}}>
                    ...
                    <div className = "desc">
                        <p>Pro</p>
                        <p className = "arcCost">{!MoYe? "$15/mo":"$150/yr"}<span>{MoYe && " +2 months free"}</span></p>
                    </div>
                </button>
            </form>
            <p className = "errorP">{!selected && "Please select a plan"}</p>
            <div className = "MoYe">
                <p className = "Monthly" style = {MoYe ? {color: "hsl(231, 11%, 63%)"} : {color: "hsl(213, 96%, 18%)"}}>Monthly</p>
                <label className="switch">
                    <input type="checkbox" onChange = {handleSwitch}/>
                    <span className="slider round"></span>
                </label>
                <p className = "Yearly" style = {MoYe ? {color: "hsl(213, 96%, 18%)"} : {color: "hsl(231, 11%, 63%)"} }>Yearly</p>
            </div>
